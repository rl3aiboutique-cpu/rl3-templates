...
| `20260503_090651_[REPORT]_baseline-validation-v0.2.1.md` | current | End-to-end validation report at v0.2.1 — 97 / 97 tests pass on the rendered fullstack sandbox; covers all 8 hook scripts, pre-commit config, Claude settings, lib-shape rendering. |
| `20260502_212730_[REPORT]_baseline-validation.md` | historical (v0.2.0) | Previous validation report — 91 / 91 PASS. Superseded by the v0.2.1 report. |
